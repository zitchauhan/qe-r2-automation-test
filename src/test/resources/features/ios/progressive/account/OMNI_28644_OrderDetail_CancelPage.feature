...
@Sprint-5 @ST-OMNI-28644 @TC-OMNI-35371 
...
@Sprint-5 @ST-OMNI-28644 @TC-OMNI-35372 
Scenario: As an ASO Mobile App user, 
...
@Sprint-5 @ST-OMNI-28644 @TC-OMNI-35373 
Scenario: As an ASO Mobile App user, 
...
@Sprint-5 @ST-OMNI-28644 @TC-OMNI-35374 
Scenario: As an ASO Mobile App user, 
...
@Sprint-5 @ST-OMNI-28644 @TC-OMNI-35375 
Scenario: As an ASO Mobile App user, 
