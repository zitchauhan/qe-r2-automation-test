...
@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10648 @CR-SG
Scenario: Verify that order is gets cancelled if Guest user clicks on Yes, Cancel my Order CTA on confirmation modal
	...
	@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10650 @CR-SG
...
@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10641 @CR-SG
...
#	@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10642 @CR-SG
...
#	And Cancel Order CTA should not be displayed
#
#	@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10643 @CR-SG
...
@R2_Web @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4019 @ZYP_MYACCOUNT_K4019-10646 @CR-SG
