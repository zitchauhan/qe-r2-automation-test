...
@R2_Web @R2_Regression  @P-High @KER-3143 @ZYP_Cart_K3143-10257 @CR-RKA @1HR_R2
...
@R2_Web @R2_Regression  @KER-3143 @P-Low @ZYP_Cart_K3143-10263 @CR-RKA
...
Given user launches the browser and navigates to "ASO_HOME" page
	...
	@R2_Web @R2_Regression  @P-Low  @KER-3143 @ZYP_Cart_K3143-12506 @CR-RKA
	...
	@R2_Web @R2_Regression  @P-Low @KER-3143 @ZYP_Cart_K3143-12547 @CR-RKA
	...
	@R2_Web @R2_Regression @P-Low  @KER-3143 @ZYP_Cart_K3143-12548 @CR-RKA
	...
	@R2_Web @R2_Regression @P-High @KER-3143 @ZYP_Cart_K3143-12571 @CR-RKA
	...
	@R2_Web @R2_Regression  @P-High @KER-3143 @ZYP_Cart_K3143-8155 @CR-RKA
   ...
   Then user verify sucessfully added item MSG 
	...
	@R2_Web @R2_Regression @P-Low @KER-3143 @ZYP_Cart_K3143-8156 @CR-RKA
	...
	|# Verify following elements in Cart page "Your Cart "|
		...
		@R2_Web @R2_Regression @P-Low @KER-3143 @ZYP_Cart_K3143-8157 @CR-RKA
    ...
    @R2_Web @R2_Regression @P-High @KER-3143 @ZYP_Cart_K3143-8158 @CR-RKA
   ...
   Then user verify sucessfully added item MSG 
    ...
    @R2_Web @R2_Regression @P-High  @KER-3143 @ZYP_Cart_K3143-8159 @CR-RKA
   ...
   And user click on signin button
	...
	@R2_Web @R2_Regression @P-High @KER-3143 @ZYP_Cart_K3143-8160 @CR-RKA
   ...
   @R2_Web @R2_Regression  @KER-3143  @P-Low @ZYP_Cart_K3143-8161 @CR-RKA
...
@R2_Web @R2_Regression  @KER-3143 @P-High @ZYP_Cart_K3143-8162 @CR-RKA
...
@R2_Web @R2_Regression @P-High @KER-3143 @ZYP_Cart_K3143-8163 @CR-RKA
