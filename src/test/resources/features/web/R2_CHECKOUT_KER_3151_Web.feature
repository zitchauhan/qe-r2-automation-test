...
@R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-3151 @ZYP_CHECKOUT_K3151-10651 @CR-RK 
...
@R2_Web @R2_Regression @R2_All @P-Low @C-Checkout @KER-3151 @ZYP_CHECKOUT_K3151-8023 @CR-RK 
...
And user clicks on SignIn link from global header
   ...
   Then user clicks on one of the product category and navigates to LThree
	...
	@R2_Web @R2_Regression @R2_All @P-Low @C-Checkout @KER-3151 @ZYP_CHECKOUT_K3151-8024 @CR-RK 
