...
@C-BOPIS @R2_Web  @R2_All @P-High_Order @C-Order @CC-MyAccount_Order   @KER-4327 
...
@C-BOPIS @R2_Web  @R2_All @P-Low @C-Order @CC-MyAccount_Order   @KER-4327 
...
@C-BOPIS @R2_Web  @R2_All @P-Highest @C-Order @CC-MyAccount_Order   @KER-4327 
