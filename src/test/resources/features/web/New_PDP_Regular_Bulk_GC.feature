...
Scenario: Verify that Product Title, Rating & Review summary & Product image displayed for  regular GC
    ...
    And user verifies product Image
     ...
     @Web @PDPFaceLift @CR-Anirudh 
Scenario: Verify that Product Title, Rating & Review summary & Product image displayed for  Bulk GC
	Given user launches the browser and navigates to "ASO_HOME" page 
    ...
    And user verifies product Image
       ...
       @Web @PDPFaceLift @CR-Anirudh 
Scenario: Verify that Product price in unavailable for GC
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User searches a product "SKUForGiftCard" and navigates to PDP
	And user sets up cookie
    Then user navigates to new pdp page url "SKUForGiftCard"
...
Scenario: Verify max quantity msg with link for BULK GC is displayed for regular GC  
    ...
    And user verifies min quantity msg and link to regular GC present
      ...
      @Web @PDPFaceLift @CR-Anirudh
Scenario: Verify that Product Title, Rating & Review summary & Product image displayed for both regular and Bulk GC
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User searches a product "SKUForGiftCard" and navigates to PDP
	And user sets up cookie
    Then user navigates to new pdp page url "SKUForGiftCard"
    ...
    And user verifies can select premade card amount
     ...
     @Web @PDPFaceLift @CR-Anirudh
Scenario: Verify error message when user inputs quantity more than or less than expected
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User searches a product "SKUForGiftCard" and navigates to PDP
	And user sets up cookie
    Then user navigates to new pdp page url "SKUForGiftCard"
