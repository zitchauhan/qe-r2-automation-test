Feature: To To verify Quick View - Product Attributes
  ...
  @C-PLP @Web @Regression @KER-737 @ZYP_PLP_K737-3508 @CR-AKK
  ...
  @C-PLP @Web @Regression @KER-737 @ZYP_PLP_K737-6058 @CR-AKK
  ...
  @C-PLP @Web @Regression @KER-737 @ZYP_PLP_K737-6059 @CR-AKK
