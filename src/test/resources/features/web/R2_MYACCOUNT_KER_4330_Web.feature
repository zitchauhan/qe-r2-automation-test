Feature: B06-250 - BOPIS Order Details Page Impact
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10933 @Order @CR-MS
  Scenario: 
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10931 @Order @CR-MS @1HR_R2
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10928 @CR-MS
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10936 @CR-MS
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10934 @Order @CR-MS
  Scenario: Verify that user is able to view BOPIS order details before pickup
    Given user launches the browser and navigates to "ASO_HOME" page
    When user clicks on SignIn link from global header
    And user enter the valid emailaddress "EmailAddress"
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10930 @Order @CR-MS
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10929 @Order @CR-MS
  Scenario: Verify the details in order details section
    Given user launches the browser and navigates to "ASO_HOME" page
    When user clicks on SignIn link from global header
    And user enter the valid emailaddress "EmailAddress"
  ...
  @C-BOPIS @R2_Web @R2_All @P-High_Order @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10935 @Order @CR-MS
