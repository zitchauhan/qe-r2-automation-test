...
@R2_Web   @R2_All @P-Low @C-Order @CC-Cart_Order @KER-3166 @ZYP_CART_K3166-8090 @CR-DPK
...
@R2_Web   @R2_All @P-Low @C-Order @CC-Cart_Order @KER-3166 @ZYP_CART_K3166-8091 @CR-DPK
...
@R2_Web @C-Order @CC-Cart_Order @R2_All @P-Low  @KER-3166 @ZYP_CART_K3166-8092 @CR-DPK
...
Scenario: Verify promotion got applied to the product when user applied %off promotion on product level in cart--with promocode
 ...
 @R2_Web   @R2_All @P-Low @C-Order @CC-Cart_Order @KER-3166 @ZYP_CART_K3166-9593 @CR-DPK 
