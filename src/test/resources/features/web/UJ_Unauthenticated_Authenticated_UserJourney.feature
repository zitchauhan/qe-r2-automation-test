Feature: To Verify Unauthenticated/Authenticated UserJourney
  ...
  @SIT_UserJourney @ZYP_K6809-7068 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7069 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7070 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7097 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7072 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7073 @KER-6809 @C-UnauthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7074 @KER-6809 @C-AuthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7075 @KER-6809 @C-AuthenticatedUJ @Web
  ...
  @SIT_UserJourney @ZYP_K6809-7076 @KER-6809 @C-AuthenticatedUJ @Web
  Scenario: Verify Authenticated User Journey form Home Page to Footer
    Given user launches the browser and navigates to "ASO_HOME" page
    Then user should able to click on Signin button
    And user should be able to enter the signin details
   ...
   # And user is able to see the product category name in section title.
    ...
    @SIT_UserJourney @ZYP_K6809-7077 @KER-6809 @C-AuthenticatedUJ @Web
