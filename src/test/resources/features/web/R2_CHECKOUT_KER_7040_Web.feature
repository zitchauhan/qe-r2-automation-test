...
@R2_Web  @R2_All @P-low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K7040-8907 @CR-MS
...
@R2_Web  @R2_All @P-High @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-12028 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-8906 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-11946 @CR-MS
Scenario: Verify that user is able to proceed with checkout if user does not selects required product attributes
 Given user launches the browser and navigates to "ASO_HOME" page
    And user clicks on SignIn link from global header 
	And user enter the valid emailaddress "UserWithSavedAddressAndPayment" 
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-12030 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-12031 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-11947 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-12032 @CR-MS
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-12033 @CR-MS
Scenario: Verify that if Prop65 shipping restricted to CA, and user has CA as default address in profile then error message is displayed on checkout
 Given user launches the browser and navigates to "ASO_HOME" page
    And user clicks on SignIn link from global header 
	And user enter the valid emailaddress "UserWithDefaultCaliforniaAddress" 
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-8903 @CR-MS
Scenario: Verify that user should be displayed with error message if they try to ship restricted items to restricted shipping address
 Given user launches the browser and navigates to "ASO_HOME" page
    And user clicks on SignIn link from global header 
	And user enter the valid emailaddress "UserWithDefaultCaliforniaAddress" 
...
@R2_Web  @R2_All @P-Low @C-Order @CS-Checkout_Order   @KER-7040 @ZYP_CHECKOUT_K6655-8908 @CR-MS
Scenario: Verify that user should be displayed with error message if they try to ship restricted items to restricted shipping address
 Given user launches the browser and navigates to "ASO_HOME" page
    And user clicks on SignIn link from global header 
	And user enter the valid emailaddress "UserWithDefaultCaliforniaAddress" 
