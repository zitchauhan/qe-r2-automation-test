...
@R2_Web  @R2_All @P-Highest @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9524 @CR-AKK
Scenario: Verify user can navigates to Order confirmation page
	...
	@R2_Web  @R2_All @P-Highest @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9525 @CR-AKK
...
@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9521 @CR-AKK
Scenario: To Verify user can see the BUY NOW button in PDP
	...
	@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10316 @CR-AKK
Scenario: Verify user can see order placed for selected single SKU on the PDP
	Given user launches the browser and navigates to "ASO_HOME" page 
	When user clicks on SignIn link from global header 
	And user enter the valid emailaddress "UserWithSavedAddressAndPayment" 
...
@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9523 @CR-AKK @1HR_R2
Scenario: Verify user can process the order
    ...
    |EnableBuyNow_btn|
 	...
 	@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10317 @CR-AKK
Scenario: Verify Shipping address and method has no errors or does not require user attention Then user should be navigated to Order confirmation page
	...
	@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10318 @CR-AKK
Scenario: Verify Payment information is authorized successfully Then user should be navigated to Order confirmation page
	...
	|Order Number|
		...
		@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10329 @CR-AKK
Scenario: Verify Academy.com should not consider any persistent item(s) in my cart while placing order using "Buy Now" from PDP
	...
	@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10330 @CR-AKK
...
@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10331 @CR-AKK
...
@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-12336 @CR-AKK
Scenario: Verify Buy Now is applicable for Bundle / Package Item(s)
	...
	@R2_Web  @R2_All @P-High @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-12337 @CR-AKK
Scenario: Verify Buy Now is applicable for Baits
	...
	Then verify the buy now button is clickable
		...
		@R2_Web  @R2_All @P-Low @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-12339 @CR-AKK
Scenario: Verify Buy Now is not applicable for following items SOF Age Restriction Items Item(s) having only In store Inventory while loading PDP
	...
	@R2_Web  @R2_All @P-Low @C-Order @C-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10322 @CR-AKK
