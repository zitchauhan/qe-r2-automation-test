...
@R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-4332 @ZYP_CHECKOUT_K4332-10331 @CR-AKK
...
@R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-4332 @ZYP_CHECKOUT_K4332-12336 @CR-AKK
Scenario: Verify Buy Now is applicable for Bundle / Package Item(s)
	...
	@R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-4332 @ZYP_CHECKOUT_K4332-12337 @CR-AKK
Scenario: Verify Buy Now is applicable for Baits
	...
	Then verify the buy now button is clickable
		...
		@R2_Web @R2_Regression @R2_All @P-Low @C-Checkout @KER-4332 @ZYP_CHECKOUT_K4332-12339 @CR-AKK
Scenario: Verify Buy Now is not applicable for following items SOF Age Restriction Items Item(s) having only In store Inventory while loading PDP
	...
	@R2_Web @R2_Regression @R2_All @P-Low @C-Checkout @KER-4332 @ZYP_CHECKOUT_K4332-10322 @CR-AKK
