Feature: To Verify the functionality of "Weekly Ad Link" in the Global Header.
  ...
  @Web @All @C-HP @Regression @KER-729 @ZYP_K729-2815
  ...
  @Web @All  @C-HP @Regression @KER-729 @ZYP_K729-2816
  ...
  @Web @All @C-HP  @Regression @KER-729 @ZYP_K729-5621
  ...
  @Web @All @C-HP  @Regression @KER-729 @ZYP_K729-5622
  ...
  @Web @All @C-HP  @Regression @KER-729 @ZYP_K729-5625
  ...
  @Web @All @C-HP @Sanity @Regression @KER-729 @ZYP_K729-5630
