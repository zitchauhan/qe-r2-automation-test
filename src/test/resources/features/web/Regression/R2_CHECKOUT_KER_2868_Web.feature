...
@R2_Web @CB-MyAccount @R2_All @1HR_R2 @C-BOPIS @KER-2868 @ZYP_MYACCOUNT_K2868-10722 @P1 @RegressionP1 @abc @TC-OMNI-13456
...
@R2_Web @C-NonOrder @CC-Checkout_Order @R2_All @1HR_R2 @C-BOPIS @C1-Message_B
...
#------------------------FROM HERE THE FLOW NEEDS TO BE CHECKED AS IT IS WRONGLY AUTOMATED--------------------------
