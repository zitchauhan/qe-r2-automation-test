Feature: [Web]  Product Card
  ...
  @C-PLP @Web @Regression @KER-224 @ZYP_PLP_K224-2020 @CR-RKA
  ...
  @C-PLP @Web @Regression @KER-224 @ZYP_PLP_K224-3000 @CR-RKA
  ...
  @C-PLP @Web @Regression @KER-224 @ZYP_PLP_K224-2977 @CR-RKA
