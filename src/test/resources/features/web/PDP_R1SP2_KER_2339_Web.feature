...
@Regression @Sanity @Web @All @KER-2339  @ZYP_K2339-3365 @C-PDP @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-9097 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-9098 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6685 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6675 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6678 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6679 @CR-SG
...
@Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6683 @CR-SG
Scenario: [UI]- Verify user should be able to see breadcrumb from store Locator landing page-Desktop 
    ...
    @Regression @Sanity @Web @All @KER-2339 @C-PDP  @ZYP_K2339-6684 @CR-SG
