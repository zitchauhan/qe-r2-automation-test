Feature: B07-250 - Gift Card - Authenticated User: Add New Gift Card at Checkout
  ...
  @R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-6822 @1HR_R2 @ZYP_CHECKOUT_K6822-7949 @CR-GK
  ...
  @R2_Web @R2_Regression @R2_All @P-High @C-Checkout @KER-6822 @ZYP_CHECKOUT_K6822-7917 @CR-GK
  ...
  @R2_Web @R2_All @P-Highest @1HR @C-Order @CC-Checkout_Order @KER-6822 @ZYP_CHECKOUT_K6822-10193 @CR-GK @C1-Message
  Scenario: 
