...
@R2_Mobile @R2_Regression @R2_All @1HR_R2 @P-Highest @1HR_R2 @C-Cart @KER-2871 @ZYP_CART_K2871-9989 @CR-SK 
Scenario:  Verify that unauthenticated user is able to see the nearest store location and store details in the header on Home page
	...
	And user clicks on the burger menu
	Then user is able to see nearest store location "FindStoreZipcodeNearestStore" in burger menu