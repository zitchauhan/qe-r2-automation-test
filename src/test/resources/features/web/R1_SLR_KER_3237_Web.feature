Feature: Verify the user see search suggestions based on the data entered in the search box
  ...
  @C-SLR @Web @All  @Regression @KER-3237  @ZYP_SLR_K3237-4384 @Rerun @1HR
  ...
  @C-SLR @Web @All  @Regression @KER-3237  @ZYP_SLR_K3237-4380
  ...
  @C-SLR @Web @All  @Regression @KER-3237  @ZYP_SLR_K3237-5179
  ...
  @C-SLR @Web @All  @Regression @KER-3237  @ZYP_SLR_K3237-5180 
  ...
  @C-SLR @Web @All  @Regression @KER-3237  @ZYP_SLR_K3237-4382 @Rerun		
