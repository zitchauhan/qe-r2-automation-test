...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-8692 @CR-MS
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-8721 @CR-MS
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-12346 @CR-MS @1HR_R2
...
##Defect-KER-13488
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-12348 @CR-MS
...
@R2_Web   @R2_All @P-High_Order @C-Order @CC-Checkout_Order @KER-6655 @ZYP_CHECKOUT_K6655-8726 @CR-MS
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-8731 @CR-MS
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order  @KER-6655 @ZYP_CHECKOUT_K6655-8732 @CR-MS @1HR_R2
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order @KER-6655 @ZYP_CHECKOUT_K6655-12345 @CR-MS @1HR_R2
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-8735 @CR-MS
Scenario: Verify that Authenticated user is able to view Enable Buy Now button on PDP if user does not have saved payment and Shipping Address details
    Given user launches the browser and navigates to "ASO_HOME" page
    And user clicks on SignIn link from global header 
	And user enter the valid emailaddress "emailWithOutPhonenumber" 
...
@R2_Web  @R2_All @P-High_Order @C-Order @CC-Checkout_Order @KER-6655 @ZYP_CHECKOUT_K6655-8693 @CR-MS
...
@R2_Web @C-Order @CC-Checkout_Order @R2_All @P-High_Order   @KER-6655 @ZYP_CHECKOUT_K6655-8727 @CR-MS @1HR_R2
