Feature: To Verify SearchDex: Brand Pages 
 ...
 @Regression @Web @All @C-PLP @KER-5271 @ZYP_PLP_K5271-6390 @CR-AKK 
Scenario: To verify SearchDex Links on - L1 Page 
 ...
 @Regression @Web @All @C-PLP @KER-5271 @ZYP_PLP_K5271-6391 @CR-AKK 
Scenario: To verify SearchDex Links on - L2 Page 
 ...
 @Regression @Web @All @C-PLP @KER-5271 @ZYP_PLP_K5271-6392 @CR-AKK 
