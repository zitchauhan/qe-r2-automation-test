...
Feature: [Desktop]Components - Header
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-1972 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4055 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4061 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4063 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4065 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4067 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4069 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4070 @CR-RKA
  ...
  @C-HP @Web @RegressionHP @KER-262 @ZYP_HP_K262-4066 @CR-RKA
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-2729 @CR-RKA
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-2730 @CR-RKA
  Scenario: Verify that the store details are displayed for guest user
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User should be able to click on Find Store
    When User select store with "Postal_Code"
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-2734 @CR-RKA
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-6530 @CR-RKA
 ...
 @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-6533 @CR-SG @RBeta
 ...
 @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262 @CR-RKA @BrokenLink @Broken @TC_BL_01 
    Scenario: Verify all broken URL's on Home page
    Given user launches the browser and navigates to "ASO_HOME" page
		Then verfy all link url's status code is 200    

  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11665 @CR-RKA @BrokenLink @Broken @TC_BL_02 
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11666 @CR-RKA @BrokenLink @Broken @TC_BL_03
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11667 @CR-RKA @BrokenLink @Broken @TC_BL_04
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11668 @CR-RKA @BrokenLink @Broken @TC_BL_05
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11669 @CR-RKA @BrokenLink @Broken @TC_BL_09
  Scenario: Verify all broken URL's on Reskin page
   ...
   @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262_Image @CR-RKA @BrokenImage @Broken @TC_BIM_01
    Scenario: TC_1- Verify all Image broken URL's on Home page
    Given user launches the browser and navigates to "ASO_HOME" page
    Then verfy all Image link urls status code is 200
    
    
    @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11665_Image @CR-RKA @BrokenImage @Broken  @TC_BIM_02
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11666_Image @CR-RKA @BrokenImage @Broken @TC_BIM_03
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11667_Image @CR-RKA @BrokenImage @Broken @TC_BIM_04
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11668_Image @CR-RKA @BrokenImage @Broken @TC_BIM_05
  ...
  @Web @All @C-HP @RegressionHP @KER-262 @ZYP_HP_K262-11669_Image @CR-RKA @BrokenImage @Broken @TC_BIM_09
