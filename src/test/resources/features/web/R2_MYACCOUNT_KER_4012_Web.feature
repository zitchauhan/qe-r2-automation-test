...
@R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-4012 @ZYP_MYACCOUNT_K4012-10667 @CR-MS
...
@R2_Web @R2_Regression @R2_All @P-Low @C-MyAccount @KER-4012 @ZYP_MYACCOUNT_K4012-10663 @CR-MS
...
@R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-4012 @ZYP_MYACCOUNT_K4012-10668 @CR-MS
...
@R2_Web @R2_Regression @R2_All @P-Highest @C-MyAccount @KER-4012 @ZYP_MYACCOUNT_K4012-11149 @CR-MS
Scenario: Verify Cancel Order link for each order
    Given user launches the browser and navigates to "ASO_HOME" page 
	And user clicks on   link from global header 
	And user enter the valid emailaddress "EmailAddress" 
	And user enter the valid password "Password" 
	And user click on signin button
	And user click on MyAccount
...
@R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-4012 @ZYP_MYACCOUNT_K4012-10672 @CR-MS
Scenario: Verify that Authenticated User is able to navigate back to order details page from cancellation confirmation page
    ...
    |Order_Back_To_Order_Lnk|
    |Order_Cancel_lnk|
    And User Clicks on Cancel Order link
    And User clicks on No Button on confirmation modal
    Then Verify below Sub/Main Module of My Account
    |#Verify following elements in my account order details|
    |Order_Back_To_Order_Lnk|
