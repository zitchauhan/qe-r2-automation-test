...
@C-BOPIS @R2_Web @R2_Regression @R2_All @P-Highest @C-Cart @KER-3178 @ZYP_CART_K3178-9940 @CR-AG @1HR_R2 
...
Given user launches the browser and navigates to "ASO_HOME" page 
    ...
    @C-BOPIS @C-BOPIS @R2_Web @R2_Regression @R2_All @P-Highest @C-Cart @KER-3178 @ZYP_CART_K3178-9941 @CR-AG
 ...
 Given user launches the browser and navigates to "ASO_HOME" page 
   ...
   Then Find in Store modal should get open
    ...
    @C-BOPIS @R2_Web @R2_Regression @R2_All @P-Highest @C-Cart @KER-3178 @ZYP_CART_K3178-9942 @CR-AG
...
Given user launches the browser and navigates to "ASO_HOME" page 
    ...
    @C-BOPIS @R2_Web @R2_Regression @R2_All @P-High @C-Cart @KER-3178 @ZYP_CART_K3178-9943 @CR-AG
...
Given user launches the browser and navigates to "ASO_HOME" page 
    ...
    @C-BOPIS @R2_Web @R2_Regression @R2_All @P-High @C-Cart @KER-3178 @ZYP_CART_K3178-9944 @CR-AG
...
@C-BOPIS @R2_Web @R2_Regression @R2_All @P-Medium @C-Cart @KER-3178 @ZYP_CART_K3178-9945 @CR-AG
...
@C-BOPIS @R2_Web @R2_Regression @R2_All @P-Medium @C-Cart @KER-3178 @ZYP_CART_K3178-9946 @CR-AG
