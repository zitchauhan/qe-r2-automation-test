Feature: Web Automation Sanity Test Cases Mimicing manual Scenarios
   ...
   @AutomationSanityR1  @AS1 @WAST-01 @AutomationSanity @1HR 
  ...
  @AutomationSanityR1   @AS2 @WAST-02 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-09 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-10 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-11 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-12 @AutomationSanity
  ...
  @AutomationSanityR1 @AS1 @WAST-13 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-14 @AutomationSanity
  ...
  @AutomationSanityR1 @AS1 @WAST-15 @AutomationSanity
  ...
  @AutomationSanityR1 @AS1 @WAST-17 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-18 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-21 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-22 @AutomationSanity
  ...
  @AutomationSanityR1 @AS1 @WAST-24 @AutomationSanity @1HR
  ...
  @AutomationSanityR1 @AS1 @WAST-25 @AutomationSanity
  ...
  Scenario: TC_30-Verify Navigation from L1 to Homepage by clicking on ASO logo
    ...
    Then User should be navigated to Home_Page
     ...
     @AutomationSanityR1 @AS1 @WAST-27 @AutomationSanity @1HR
