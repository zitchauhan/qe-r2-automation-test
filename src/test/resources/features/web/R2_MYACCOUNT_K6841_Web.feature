Feature: E02-250 - Edit Credit/Debit Card in Account
  ...
  @R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-6841 @ZYP_MYACCOUNT_K6841-10630 @CR-GK
  Scenario: 
  ...
  @R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-6841 @ZYP_MYACCOUNT_K6841-10631 @CR-GK
  Scenario: 
  ...
  #@ZYP_MYACCOUNT_K6841-10978 @CR-GK
  #Scenario:
  ...
  @R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-6841 @ZYP_MYACCOUNT_K6841-10632 @CR-GK
