...
@C-PLCC @Regression @All @PLCC-90 @CR-Smeetha @Mobile
...
@C-PLCC @Regression @All @PLCC-90 @CR-Smeetha @Mobile 
Scenario: Verify the system behavior when user clicks on Continue button on Application model by providing in-valid required information/details
...
@C-PLCC @Regression @All @PLCC-90 @CR-VS @Mobile
