Feature: To Verify Get City adn State of store Locator without sign-in
  ...
  @All-R2 @CR-AG @api @C1-MyAccount @C-MyAccount-Profile-Details @ZYP_MyAccount_ProfileDetailed_12282
  Scenario: TC_1 - verify Get City and State of Store Locator without Sign-in
    Given "AddressCity" validating with "zipCode"
    Then Verify response status code as 200

  @All-R2 @CR-AG @api @C1-MyAccount @C-MyAccount-Profile-Details @ZYP_MyAccount_ProfileDetailed_12283
  Scenario: TC_1 - verify Get City and State of Store Locator without Sign-in
    Given "AddressCity" validating with "zipCode"
    And validate jsonSchema "StoreLocator_FindCityAndState"

  @All-R2 @CR-AG @api @C1-MyAccount @C-MyAccount-Profile-Details @ZYP_MyAccount_ProfileDetailed_12869
  Scenario: TC_1 - verify Get City and State of Store Locator without Sign-in
    Given "AddressCity" validating with "zipCode"
    Then Validated response details of "state"
    Then Validated response details of "city"

  @All-R2 @CR-RT @api @C1-MyAccount @C-MyAccount-Inventory @ZYP_MyAccount_Inventory_13164
  Scenario: TC_2 - verify Create store pickup inventory for the given Skus for particular store
    ...
    Then Verify response status code as 200
    And validate jsonSchema "CreateStorePickupInventorySchema"
    Then Validated response details of "store[0].storeId"
    Then Validated response details of "store[0].skus[0].skuId"

  @All-R2 @CR-RT @api @C1-MyAccount @C-MyAccount-Inventory @ZYP_MyAccount_Inventory_12285
  ...
  @All-R2 @CR-RT @api @C1-MyAccount @C-MyAccount-Inventory @ZYP_MyAccount_Inventory_12870
  ...
  @All-R2 @CR-RT @api @C1-MyAccount @C-MyAccount-Inventory @ZYP_MyAccount_Inventory_12871
