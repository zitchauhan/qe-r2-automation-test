Feature: To verify the Search by SearchTerm API Services
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6825
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6826
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6827
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6828
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6829
  Scenario Outline: : Validate the Search by SearchTerm with shirts Requried Property Values are not null
    ...
    And Validate the Search by SearchTerm Requried Property Values contains with "<SearchTermText>"
      | name |
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6830
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6831
  ...
  @Regression @Sanity @All @api @KER-1959 @ZYP-6832
