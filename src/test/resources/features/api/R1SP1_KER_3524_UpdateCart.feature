Feature: To verify the Update to Cart API Services
  ...
  @Regression @Sanity @All @api @KER-3524 @ZYP-7164
  ...
  @Regression @Sanity @All @api @KER-3524 @ZYP-7165
  ...
  @Regression @Sanity @All @api @KER-3524 @ZYP-7166
  ...
  @Regression @Sanity @All @api @KER-3524 @ZYP-7167
