Feature: To verify the MiniCart API Services
  ...
  @Regression @Sanity @All @api @KER-725 @ZYP-3058
  ...
  @Regression @Sanity @All @api @KER-725 @ZYP-6580
  ...
  @Regression @Sanity @All @api @KER-725 @ZYP-6581
  ...
  @Regression @Sanity @All @api @KER-725 @ZYP-6582
...
#
  #@Regression @Sanity @All @api @KER-725 @ZYP-??
