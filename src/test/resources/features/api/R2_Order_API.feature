Feature: Verify Order API endpoint services
  ...
  @All-R2 @C1-Checkout @C2-Login @api @R2_AAST-01 @CR-VK @ZYP_Order_Login_12273
  ...
  @All-R2 @C1-Checkout @C2-AddPromo @api @R2_AAST-02 @CR-VK @ZYP_Order_AddPromo_12275
  ...
  @All-R2 @C1-Checkout @C2-GetPromo @api @R2_AAST-03 @CR-VK @ZYP_Order_GetPromo_12276
  ...
  @All-R2 @C1-Checkout @C2-GetPromo @api @R2_AAST-04 @CR-VK @ZYP_Order_GetPromo_12277
  Scenario: TC_4 - Get Promo Code schema validation of an order
    Given "GetCartUrl" endpoint for getting cart
    Then "OrderUrl" endpoint with "/promocode" for getting promocode of an order
    And Verify response status code as 200

  @All-R2 @C1-Checkout @C2-GetPromo @api @R2_AAST-04 @CR-VK @ZYP_Order_GetPromo_12279
  Scenario: TC_4 - Get Promo Code schema validation of an order
    Given "GetCartUrl" endpoint for getting cart
    Then "OrderUrl" endpoint with "/promocode" for getting promocode of an order
    Then validate jsonSchema "GetOrderPromoCode"

  @All-R2 @C1-Checkout @C2-GetOrder @api @R2_AAST-04 @CR-RT @ZYP_Order_Details_12587
  Scenario: TC_1 -Verify the Order details with SignIn user
    Given "OrderUrl" endpoint for order details
    And Verify response status code as 200

  @All-R2 @C1-Checkout @C2-GetOrder @api @R2_AAST-04 @CR-RT @ZYP_Order_Details_12588
  Scenario: TC_1 -Verify the Order details with SignIn user Json Schema
    Given "OrderUrl" endpoint for order details
    Then validate jsonSchema "R2-OrderDetailsSchema"

  @All-R2 @C1-Checkout @C2-GetOrder @api @R2_AAST-04 @CR-RT @ZYP_Order_Details_12589
  ...
  @All-R2 @C1-Checkout @C2-OrderAddress @api @R2_AAST-04 @CR-RT @ZYP_AddShippingAddress_13550
  ...
  @All-R2 @C1-Checkout @C2-OrderAddress @api @R2_AAST-04 @CR-RT @ZYP_UpdateShippingAddress_14260
  ...
  @All-R2 @C1-Checkout @C2-OrderAddress @api @R2_AAST-04 @CR-RT @ZYP_AddBillingAddress_14256
  ...
  @All-R2 @C1-Checkout @C2-OrderCart @api @R2_AAST-07 @CR-RT @ZYP_EstimatedTax_14257
  ...
  @All-R2 @C1-Checkout @C2-OrderCart @api @R2_AAST-07 @CR-RT @ZYP_EstimatedTax_14258
  ...
  @All-R2 @C1-Checkout @C2-OrderCart @api @R2_AAST-07 @CR-RT @ZYP_EstimatedTax_14259
  Scenario: TC_7 - verify the Order Cart Estimated Tax and Shipping Charge Json Response details
    Given "OrderUrl" by "?deliveryZipCode=72201&storeZipCode=" for Taxes Cart Estimated Tax and Shipping Charge
    Then Validated response details of "orders[0].orderId"

  @All-R2 @C1-Checkout @C2-RemovePromoCode @api @R2_AAST-05 @CR-VK @ZYP_Order_RemovePromoCode_12280
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_Placed_Orders_13731
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_Placed_Orders_13732
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_Placed_Orders_13733
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_ByOrderId_13734
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_ByOrderId_13735
  Scenario: TC_1 -Validate the profile placed orders get by orderId details Json Schema with SignIn user
    Given "profileorders" endpoint for get profile order by id details
    Then validate jsonSchema "R2-PlacedOrderDetailsSchema"

  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Get_ByOrderId_13736
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Search_ByOrderIdAndZipCode_13737
  ...
  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Search_ByOrderIdAndZipCode_13738
  Scenario: TC_1 -Validate the profile placed orders Search by orderId and Zip code Json Schema with SignIn user
    Given "profileorders" by "PlacedOrderZipCode" endpoint for Search profile placed orders with order id and zip code
    Then validate jsonSchema "R2-PlacedOrderDetailsSchema"

  @All-R2 @C1-Checkout @C2-ProfileOrder @api @R2_AAST-06 @CR-RT @ZYP_Search_ByOrderIdAndZipCode_13739
  Scenario: TC_1 -Verify the profile placed orders Search by orderId and Zip code JSON Response with SignIn user
    Given "profileorders" by "PlacedOrderZipCode" endpoint for Search profile placed orders with order id and zip code
    Then Validated response details of "orders[0].orderNumber"

  @All-R2 @C1-Checkout @C2-OrderDetails @api @R2_AAST-06 @CR-RT @ZYP_OrderDetails_14034
