Feature: B06-175- Mixed Cart - Order Confirmation screen
  ...
  @C-BOPIS @R2_Mobile @R2_All @P-Highest @1HR_R2 @CC-Checkout_Order @KER-2856 @ZYP_CHECKOUT_K2856-10865 @CR-RK
  ...
  @C-BOPIS @R2_Mobile @R2_All @P-High_B_Order @CC-Checkout_Order @KER-2856 @ZYP_CHECKOUT_K2856-10866 @CR-RK
  ...
  @C-BOPIS @R2_Mobile @R2_All @P-High_B_Order @CC-Checkout_Order @KER-2856 @ZYP_CHECKOUT_K2856-10867 @CR-RK
  ...
  @C-BOPIS @R2_Mobile @R2_All @P-High_B_Order @CC-Checkout_Order @KER-2856 @ZYP_CHECKOUT_K2856-10868 @CR-RK
