...
@R2_Mobile  @R2_All @P-Highest  @1HR_R2 @C-Order @C-Checkout_Order   @KER-2856 @ZYP_CHECKOUT_K2856-10865 @CR-RK
...
And User clicks on the burger menu 
	...
	@R2_Mobile  @R2_All @P-High  @C-Order @C-Checkout_Order   @KER-2856 @ZYP_CHECKOUT_K2856-10866 @CR-RK
Scenario: Verify Mixed Cart Order Confirmation - Fullfilment methods BOPIS and SOF
   ...
   Then user should able to click on Signin button
	...
	@R2_Mobile  @R2_All @P-High  @C-Order @C-Checkout_Order   @KER-2856 @ZYP_CHECKOUT_K2856-10867 @CR-RK
...
@R2_Mobile  @R2_All @P-High  @C-Order @C-Checkout_Order   @KER-2856 @ZYP_CHECKOUT_K2856-10868 @CR-RK	
...
@R2_Mobile  @R2_All @P-High  @C-Order @C-Checkout_Order   @KER-2856 @ZYP_CHECKOUT_K2856-10869 @CR-RK	
