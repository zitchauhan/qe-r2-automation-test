Feature: B06-225 - BOPIS: SMS Capture
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-Low @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10888 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10884 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10886 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10885 @CR-MS
  Scenario: Verify Phone number associated with BOPIS
    Given user launches the browser and navigates to "ASO_HOME" page
    And User clicks on the burger menu
    And user clicks on SignIn link from global header
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10891 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10892 @CR-MS
  Scenario: Verify Phone number associated with BOPIS - Un Authenticated user
    Given user launches the browser and navigates to "ASO_HOME" page
    And User clicks on the burger menu
    And user clicks on SignIn link from global header
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10893 @CR-MS
  Scenario: Verify Phone number field validation
    Given user launches the browser and navigates to "ASO_HOME" page
    And User clicks on the burger menu
    And user clicks on SignIn link from global header
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-Low @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10889 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-Low @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10890 @CR-MS
  ...
  @R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-Low @CB-Checkout @KER-4134 @ZYP_CHECKOUT_K4134-10887 @CR-MS
  Scenario: Verify Phone number associated with BOPIS - Saved Billing address
    Given user launches the browser and navigates to "ASO_HOME" page
    And User clicks on the burger menu
    And user clicks on SignIn link from global header
