...
@R2_Mobile @R2_Regression @R2_All @P-Medium @C-Checkout @KER-6760 @ZYP_CHECKOUT_K6760-8943_M @CR-SG 
...
@R2_Mobile @R2_Regression @R2_All @P-Medium @C-Checkout @KER-6760 @ZYP_CHECKOUT_K6760-9176_M @CR-SG 
...
@R2_Mobile @R2_Regression @R2_All @P-Medium @C-Checkout @KER-6760 @ZYP_CHECKOUT_K6760-9178_M @CR-SG 
Scenario: Verify that the Authorized user is able to view the details of Bulk Carrier Service -Threshold for WG items
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User clicks on the burger menu
	When user clicks on sign in link from burger menu 
	...
	@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-6760 @ZYP_CHECKOUT_K6760-11312 @CR-SG 
