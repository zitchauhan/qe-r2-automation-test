Feature: [Mobile] Page Auto Scroll

    @Regression  @Mobile   @KER-4041   @ZYP_K4041-9086  @C-PLP @1HR
   ...
   @Regression  @Mobile   @KER-4041   @ZYP_K4041-9088  @C-PLP
 ...
 @Regression  @Mobile   @KER-4041   @ZYP_K4041-9090  @C-PLP   
 Scenario: Verify the Page Auto Scroll functionality in L1 page
  ...
  @Regression  @Mobile   @KER-4041   @ZYP_K4041-9091  @C-PLP 
  ...
  @Regression  @Mobile   @KER-4041   @ZYP_K4041-9092  @C-PLP  @1HR
