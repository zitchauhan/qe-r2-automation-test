Feature: Verify presence of Global Element Header
  ...
  @1HR @KER-720  @C-HP  @Regression  @ZYP_HP_K720-4344 @All @Mobile
 ...
 @KER-720  @C-HP  @ZYP_HP_K720-5477 @Regression @All @Mobile
  Scenario: Verify presence of Global Element Header from PLP
    ...
    Then User clicks on the burger menu
     ...
     @KER-720 @C-HP   @ZYP_HP_K720-5478 @Regression @All @Mobile
