Feature: [Mobile]Verify Automatic Store Locator for Unauthenticated User 
	...
	@R2_Mobile @R2_Regression @R2_All @P-Highest @C-Cart @KER-2946 @ZYP_CART_K2946-7993 @CR-RKA 
   ...
   And User navigates to L3
	...
	@R2_Mobile @R2_Regression @R2_All @P-Highest @C-Cart @KER-2946 @ZYP_CART_K2946-7994 @CR-RKA 
