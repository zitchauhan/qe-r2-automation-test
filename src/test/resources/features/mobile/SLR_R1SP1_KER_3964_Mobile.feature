Feature: Verify the user should be able to view a search results page when the user search returns relevant results
  ...
  @SLR @Mobile  @Regression @KER-3964 @All @ZYP-4960
  ...
  @SLR @Mobile @Regression  @KER-3964 @ZYP-4967 @All
  ...
  @SLR @Mobile  @Regression @KER-3964 @ZYP-4962 @All
  ...
  @SLR @Mobile  @Regression @KER-3964 @ZYP-4965 @All
  ...
  @SLR @Mobile  @Regression @KER-3964 @ZYP-4988 @All @Rerun
