Feature: Verify the user should be able to view a search results page when the user search returns relevant results
  ...
  @C-SLR @Mobile  @Regression @KER-3964 @All  @ZYP_SLR_K3964-4960
  ...
  @C-SLR @Mobile @Regression  @KER-3964  @ZYP_SLR_K3964-4967 @All
  ...
  @C-SLR @Mobile  @Regression @KER-3964  @ZYP_SLR_K3964-4962 @All
  ...
  @C-SLR @Mobile  @Regression @KER-3964  @ZYP_SLR_K3964-4965 @All
  ...
  @C-SLR @Mobile  @Regression @KER-3964  @ZYP_SLR_K3964-4988 @All @Rerun
