Feature: To Verify the presence of "Search Box" in the Global Header
  ...
  @C-HP @Web @Regression @KER-724  @ZYP_K724-8515
  ...
  @C-HP @Web @Regression @KER-724  @ZYP_K724-8514
  ...
  @C-HP @Web @Regression @KER-724  @ZYP_K724-8513
  ...
  @C-HP @Web @Regression @KER-724  @ZYP_K724-2807
