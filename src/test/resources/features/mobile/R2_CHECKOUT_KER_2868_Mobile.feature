...
@R2_Mobile @R2_Regression @R2_All @P-Highest @1HR-R2 @C-Checkout @KER-2868 @ZYP_CHECKOUT_K2868-10722 @CR-AKK
...
Given user launches the browser and navigates to "ASO_HOME" page 
	...
	Then Verify the message on the page 
		...
		@R2_Mobile @R2_Regression @R2_All @P-Highest @1HR-R2 @C-Checkout @KER-2868 @ZYP_CHECKOUT_K2868-10709 @CR-AKK
Scenario: Verify that UnAuthenticated user is able to create an account on Order Confirmation page
Given user launches the browser and navigates to "ASO_HOME" page 
	Then User searches a product "SKUForBopisProduct" and navigates to PDP
	And user click on Add to Cart Button 
