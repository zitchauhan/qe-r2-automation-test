...
@R2_Mobile @C-Order @CC-Checkout_Order @R2_All @P-Highest @1HR_R2 @C-BOPIS
...
@R2_Mobile @C-Order @CC-Checkout_Order @R2_All @P-High_Order @KER-2868 @C-BOPIS
...
@R2_Mobile @C-Order @CC-Checkout_Order @R2_All @P-Low @KER-2868 @C-BOPIS
