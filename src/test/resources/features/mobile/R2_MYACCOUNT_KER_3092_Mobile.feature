...
Then Verify below Sub/Main Module of My Account
     ...
     |PaymentPage_AddedGiftCards_txtList				|
      ...
      @R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-3092 @ZYP_MYACCOUNT_K3092-10462_M @CR-RKA
...
Then Verify below Sub/Main Module of My Account
     ...
     @R2_Web @R2_Regression @R2_All @P-High @C-MyAccount @KER-3092 @ZYP_MYACCOUNT_K3092-10459_M @CR-RKA
