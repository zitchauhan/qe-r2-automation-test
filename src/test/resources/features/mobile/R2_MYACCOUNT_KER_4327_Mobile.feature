...
@R2_Mobile @R2_Regression @R2_All @P-High @C-MyAccount @KER-4327 
...
@R2_Mobile @R2_Regression @R2_All @P-High @1HR_R2 @C-MyAccount @KER-4327 
...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-MyAccount @KER-4327 
...
@R2_Mobile @R2_Regression @R2_All @P-Highest @C-MyAccount @KER-4327 
