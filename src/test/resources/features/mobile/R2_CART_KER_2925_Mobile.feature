...
Scenario: verify if user should be able to submit the order on the checkout page
	...
	@R2_Mobile @R2_Regression @P-High @C-Checkout @KER-2915 @ZYP_CART_K2915-8191 @CR-AG 
Scenario: Verify if user received an oder confirmation email after successfully submitting the order
    ...
    |Your confirmation email is on its way|
    	...
    	@R2_Mobile @R2_Regression @P-Highest @C-Checkout @KER-2915 @ZYP_CART_K2915-8192 @CR-AG 
...
Scenario: Verify if Order status is updated in 'My account'
 ...
 @R2_Mobile @R2_Regression @P-High @C-Checkout @KER-2915 @ZYP_CART_K2915-8194 @CR-AG 
Scenario: Verify if user can see legal disclaimer while placing the order
 ...
 @R2_Mobile @R2_Regression @P-Low @C-Checkout @KER-2915 @ZYP_CART_K2915-8195 @CR-AG 
...
@R2_Mobile @R2_Regression @P-Low @C-Checkout @KER-2915 @ZYP_CART_K2915-8196 @CR-AG 
