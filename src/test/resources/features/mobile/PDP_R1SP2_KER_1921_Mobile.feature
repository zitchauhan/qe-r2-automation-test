Feature: [Mobile]  Add to Cart on PDP
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5092 @CR-RKA
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5096 @CR-RKA @1HR
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5098 @CR-RKA
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5100 @CR-RKA
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5099 @CR-RKA @1HR
  ...
  @C-HP @Mobile @Regression @KER-1921  @ZYP_PDP_K1921-5012 @CR-RKA
