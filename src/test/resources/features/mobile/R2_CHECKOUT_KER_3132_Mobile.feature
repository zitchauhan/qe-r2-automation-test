...
@R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-3132 @ZYP_CHECKOUT_K3132-8116 @CR-RKA
Scenario: Verify Billing address on check out Page - Same as Shipping Address
        Given user launches the browser and navigates to "ASO_HOME" page 
        When User searches a product "productName" and navigates to PDP
		And user click on Add to Cart Button
...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-3132 @ZYP_CHECKOUT_K3132-8117 @CR-RKA
...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-3132 @ZYP_CHECKOUT_K3132-8118 @CR-RKA
Scenario: Verify Billing address on check out Page - new address information
...
#only validation is nedded after clicking confirm btn
 ...
 @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-3132 @ZYP_CHECKOUT_K3132-10439 @CR-RKA
