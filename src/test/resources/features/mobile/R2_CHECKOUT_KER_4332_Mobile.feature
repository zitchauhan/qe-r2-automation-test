...
@R2_Mobile  @R2_All @P-Highest @C-Order @CC-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9524 @CR-AKK
Scenario: Verify user can navigates to Order confirmation page
	...
	@R2_Mobile  @R2_All @P-Highest @C-Order @CC-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-9525 @CR-AKK
...
Scenario: Verify Buy Now is applicable for Baits
	...
	Then verify the buy now button is clickable
		...
		@R2_Mobile  @R2_All @P-Low @C-Order @CC-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-12339 @CR-AKK
Scenario: Verify Buy Now is not applicable for following items SOF Age Restriction Items Item(s) having only In store Inventory while loading PDP
	...
	@R2_Mobile  @R2_All @P-Low @C-Order @CC-Checkout_Order   @KER-4332 @ZYP_CHECKOUT_K4332-10322 @CR-AKK
