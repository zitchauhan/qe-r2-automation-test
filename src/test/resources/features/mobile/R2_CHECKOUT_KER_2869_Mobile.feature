Feature: PDP BOPIS Messaging & Variations to Customer
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10686 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10687 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10688 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10691 @CR-AKK
  Scenario: Verify that the user is able to view "Add to Wish list" CTA on PDP
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User clicks on the burger menu
    When user clicks on SignIn link from global header
  ...
  #
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10703 @CR-AKK
  Scenario: Verify that the user is able to increase the item quantity on PDP
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User clicks on the burger menu
    When user clicks on SignIn link from global header
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10706 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10707 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10708 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10717 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10695 @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-10699 @CR-AKK
