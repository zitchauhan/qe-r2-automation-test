...
@R2_Mobile @C-BOPIS @R2_NonRegression @R2_All @P-High_B @1HR_R2 @CB-Checkout @KER-2869
...
@R2_Mobile @R2_NonRegression @R2_All @P-High_B @C-BOPIS @1HR_R2 @CB-Checkout @KER-2869
...
@R2_Mobile @R2_NonRegression @R2_All @P-Low  @C-BOPIS @CB-Checkout @KER-2869
...
@R2_Mobile @R2_NonRegression @R2_All @C-BOPIS @P-Low @CB-Checkout @KER-2869
...
Verify that the user is able to view In-Store Pickup Available in its correct state on PDP 
	...
	Then Verify the message on the page 
		...
		| In-Store Pickup Available                         |
		 ...
		 @R2_Mobile @R2_NonRegression @C-BOPIS @R2_All @P-Low @CB-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-KER-10701 @CR-AKK
...
Given user launches the browser and navigates to "ASO_HOME" page
	...
	Then verify that Find a Store Modal is displayed
	 ...
	 @R2_Mobile @R2_NonRegression @R2_All @P-Low  @C-BOPIS @CB-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-KER-10704 @CR-AKK
...
Given user launches the browser and navigates to "ASO_HOME" page
 ...
 @R2_Mobile @R2_NonRegression @R2_All @P-Low @C-BOPIS  @CB-Checkout @KER-2869 @ZYP_CHECKOUT_K2869-KER-10705 @CR-AKK
	Scenario: Verify that user sees appropriate message If shipping is unavailable for an item
Given user launches the browser and navigates to "ASO_HOME" page
	When user clicks on SignIn link from global header 
	And user enter the valid emailaddress "EmailAddress" 
