...
@C-BOPIS @R2_Mobile @R2_NonRegression @R2_All @P-High_B @1HR_R2 @CB-Cart @KER-4231 @ZYP_CART_K4231-8894 
@CR-GK 
...
@C-BOPIS @R2_Mobile @R2_NonRegression @R2_All @P-High_B @CB-Cart @KER-4231 @ZYP_CART_K4231-8898 
@CR-GK 
Scenario: Verify Authenticated user able to see the BOPIS items for pickup 
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User clicks on the burger menu 
...
@C-BOPIS @R2_Mobile @R2_NonRegression @R2_All @P-High_B @CB-Cart @KER-4231 @ZYP_CART_K4231-8891 
@CR-GK 
Scenario: 
