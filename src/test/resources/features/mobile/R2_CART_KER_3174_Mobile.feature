Feature: B06-225- BOPIS Age Restriction Flag in Checkout
  ...
  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Cart @KER-3174 @ZYP_CART_K3174-KER-10274 @CR-RK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Cart @KER-3174 @ZYP_CART_K3174-KER-10271 @CR-RK
