Feature: Verify the user should be able to view a search results page when the user search returns relevant results
  ...
  @SLR @Mobile @Regression @All @KER-3237 @ZYP-5145 @Rerun
  ...
  @SLR @Mobile @Regression  @All @KER-3237 @ZYP-5113 @Rerun
  ...
  @SLR @Mobile @Regression  @All @KER-3237 @ZYP-4381
  ...
  @SLR @Mobile  @Regression @All @KER-3237 @ZYP-5184
  ...
  @SLR @Mobile  @Regression @All @KER-3237 @ZYP-5183
  ...
  @SLR @Mobile @Regression  @All @KER-3237 @ZYP-5109 @Rerun
