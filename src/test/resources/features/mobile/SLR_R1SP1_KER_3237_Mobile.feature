Feature: Verify the user should be able to view a search results page when the user search returns relevant results
  ...
  @C-SLR @Mobile @Regression @All @KER-3237  @ZYP_SLR_K3237-5145 @Rerun @1HR
  ...
  @C-SLR @Mobile @Regression  @All @KER-3237  @ZYP_SLR_K3237-5113 @Rerun
  ...
  @C-SLR @Mobile @Regression  @All @KER-3237  @ZYP_SLR_K3237-4381 @1HR
  ...
  @C-SLR @Mobile  @Regression @All @KER-3237  @ZYP_SLR_K3237-5184
  ...
  @C-SLR @Mobile  @Regression @All @KER-3237  @ZYP_SLR_K3237-5183
  ...
  @C-SLR @Mobile @Regression  @All @KER-3237  @ZYP_SLR_K3237-5109 @Rerun
