...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10933 @CR-MS
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10931 @CR-MS
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10928 @CR-MS
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10936 @CR-MS
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10930 @CR-MS
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10929 @CR-MS
Scenario: Verify the details in order details section
   Given user launches the browser and navigates to "ASO_HOME" page
   Then User clicks on the burger menu 
	Then user should able to click on Signin button 
...
@R2_Mobile @R2_Regression @R2_All @P-High @R2_Order @C-MyAccount @KER-4330 @ZYP_MYACCOUNT_K4330-10935 @CR-MS
