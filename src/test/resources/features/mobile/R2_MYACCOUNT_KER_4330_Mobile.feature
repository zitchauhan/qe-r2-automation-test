Feature: B06-250 - BOPIS Order Details Page Impact
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10933 @CR-MS
  Scenario: 
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10931 @CR-MS
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10928 @CR-MS
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10936 @CR-MS
  ...
  @R2_Mobile @R2_All @P-High @1HR_R2 @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10934 @CR-MS
  Scenario: Verify that user is able to view BOPIS order details before pickup
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User clicks on the burger menu
    Then user should able to click on Signin button
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10930 @CR-MS
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10929 @CR-MS
  Scenario: Verify the details in order details section
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User clicks on the burger menu
    Then user should able to click on Signin button
  ...
  @R2_Mobile @R2_All @P-High @C-Order @CC-MyAccount_Order @KER-4330 @ZYP_MYACCOUNT_K4330-10935 @CR-MS
