...
Scenario: Verify the SignUp functionality for new customer 
	Given user launches the browser and navigates to "ASO_HOME" page 
	#    Then User clicks on the burger menu
...
Scenario:
To verify user can view 'My Account' from a drop down account summary upon successful log in 
	Given user launches the browser and navigates to "ASO_HOME" page 
	#    Then User clicks on the burger menu
	#    When user to click on sing in and navigate to sign in page
	Then User clicks on the burger menu 
...
#    When user to click on sing in and navigate to sign in page
 Then User clicks on the burger menu
    ...
    Examples: 
          | username       | password   |
      | mondayacademy21@mailinator.com | pass1234 |
...
Scenario:
Verify the Signin functionality for empty email address and empty password 
	Given user launches the browser and navigates to "ASO_HOME" page 
	#    Then User clicks on the burger menu
	#    When user to click on sing in and navigate to sign in page
	Then User clicks on the burger menu 
...
Scenario Outline:
Mobile-Verify the Sign-In functionality for Guest User before clicking on search button 
	Given user launches the browser and navigates to "ASO_HOME" page 
...
Scenario Outline: 
Mobile-Verify the Sign-In functionality for Guest User after clicking on search button 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User to verify serch option box is available 
...
Scenario: Verify the global navigation 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
...
Scenario: Mobile-Verify the Account Summary details from MyAccount 
Given user launches the browser and navigates to "ASO_HOME" page 
#    Then User clicks on the burger menu
#    When user to click on sing in and navigate to sign in page
Then User clicks on the burger menu 
...
Scenario: To Verify the MyAccount dropdown 
Given user launches the browser and navigates to "ASO_HOME" page 
#    Then User clicks on the burger menu
#    When user to click on sing in and navigate to sign in page
Then User clicks on the burger menu 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262 @CR-SG @BrokenLink 
@Broken 
Scenario: Verify all broken URL's on Home page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then verfy all link url's status code is 200 

@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11665 @CR-SG 
@BrokenLink @Broken 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11666 @CR-SG 
@BrokenLink @Broken 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11667 @CR-SG 
@BrokenLink @Broken 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11668 @CR-SG 
@BrokenLink @Broken 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11669 @CR-SG 
@BrokenLink @Broken 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on Home page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then verfy all Image link urls status code is 200 

@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11665_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on L1 page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11666_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on L2 page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11667_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on L3 page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11668_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on PDP page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
...
@Mobile @All @C-HP @Regression @KER-262 @ZYP_HP_K262-11669_Image @CR-SG 
@BrokenImage @Broken 
Scenario: Verify all broken URL's on Reskin page 
Given user launches the browser and navigates to "ASO_HOME" page 
Then User clicks on the burger menu 
