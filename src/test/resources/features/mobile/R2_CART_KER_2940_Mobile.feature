...
#	@R2_Mobile @R2_Regression @R2_All @P-Low @C-Cart @KER-2940 @ZYP_CART_K2940-8064_M @CR-AKK
...
##
##
#	@R2_Mobile @R2_Regression @R2_All @P-High @C-Cart @KER-2940 @ZYP_CART_K2940-8065_M @CR-AKK
...
#
#
#@R2_Mobile @R2_Regression @R2_All @P-High @C-Cart @KER-2940 @ZYP_CART_K2940-8054_M @CR-AKK 
#Scenario: To verify the Sub-total for all items in cart 
#	Given user launches the browser and navigates to "ASO_HOME" page 
#	And User clicks on the burger menu 
#	When user clicks on SignIn link from global header 
...
#	Then verify that itemized subtotal for each item in cart is displayed 
#	
#@R2_Mobile @R2_Regression @R2_All @P-Low @C-Cart @KER-2940 @ZYP_CART_K2940-8058_M @CR-AKK 
...
#	
#@R2_Mobile @R2_Regression @R2_All @P-Low @C-Cart @KER-2940 @ZYP_CART_K2940-8053_M @CR-AKK 	
...
#
#@R2_Web @R2_Regression @R2_All @P-Low @C-Cart @KER-2940 @ZYP_CART_K2940-8059_M @CR-AKK 
