Feature: [Mobile]  Product Card
  ...
  @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-4920 @CR-RKA
  Scenario: User should be able to view the product image  on PLP
    ...
    @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9422 @CR-RKA
  Scenario: User  be able to view the colour option on product PLP
    ...
    Then user verify colour option in image of product 
     ...
     @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9423 @CR-RKA
  Scenario: User  be able to view the product price  on L2
   ...
   @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9425 @CR-RKA
 ...
 @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9427 @CR-RKA
 ...
 @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-5569 @CR-RKA
 Scenario: User  be able to navigate to PDP by clicking on image of product
  Given user launches the browser and navigates to "ASO_HOME" page
    ...
    @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9429 @CR-RKA
 ...
 @C-PLP @Mobile @Regression @KER-224	  @ZYP_K224-9430
