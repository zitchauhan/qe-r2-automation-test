...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-3139
@ZYP_CART_K3139-8214 @CR-AG 
Scenario:
...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-3139
@ZYP_CART_K3139-8220 @CR-AG @1HR_R2 
