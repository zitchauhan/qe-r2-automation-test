Feature: To Verify the functionality of "Weekly Ad Link" in the Global Header.
  ...
  @Mobile @All @Sanity @Regression @HomePage @KER-729 @ZYP-1970
  ...
  @Mobile @All @Regression  @HomePage @KER-729 @ZYP-2814
  ...
  @Mobile @All  @Sanity @Regression @HomePage  @KER-729 @ZYP-5626
  ...
  @Mobile @All @Regression @HomePage  @KER-729 @ZYP-5627
  ...
  @Mobile @All @Regression @HomePage  @KER-729 @ZYP-5628
  ...
  @Mobile @All @Regression  @HomePage @KER-729 @ZYP-5629
