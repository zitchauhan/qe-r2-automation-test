...
@R2_Mobile @P-High @C-MyAccount @KER-4011 @ZYP_MYACCOUNT_K4011-10040_M @CR-SK
@AutomationSanityR2 
Scenario:
...
@R2_Mobile @P-High @C-MyAccount @KER-4011 @ZYP_MYACCOUNT_K4011-10301_M @CR-SK
@AutomationSanityR2 
...
@R2_Mobile  @P-High @CR-SK @AutomationSanityR2 
...
@R2_Mobile  @CR-SK @AutomationSanityR2
...
@R2_Mobile @P-High @C-Cart @KER-3166 @ZYP_K3166-9604_M @CR-DP
@AutomationSanityR2 
Scenario:
...
@R2_Mobile @P-Highest @C-Cart @KER-3127 @ZYP_K3127-8166_M @CR-RK
@AutomationSanityR2 
Scenario:
...
@R2_Mobile @P-Highest @C-Cart @KER-2942 @ZYP_K2942-8044_M @CR-DP
@AutomationSanityR2 
...
@R2_Mobile @P-Highest @C-Cart @KER-2939 @ZYP-K2939_9615_M @CR-AKK
@AutomationSanityR2 
Scenario: 
...
@R2_Mobile  @P-High @C-Checkout @KER-6824 @ZYP_CHECKOUT_K6821-8629_M @CR-DPK @AutomationSanityR2 
...
@R2_Mobile @P-High @C-Checkout @KER-6822 @ZYP_CHECKOUT_K6822-7954_M @CR-GK
@AutomationSanityR2 
...
@R2_Mobile @P-High @C-Checkout @KER-3392 @ZYP_CHECKOUT_K3392-8147_M @CR-RK
@AutomationSanityR2 
...
@R2_Mobile @P-Highest @C-Cart @KER-2872 @ZYP_CART_K2872-8710_M @CR-DPK
@AutomationSanityR2 
Scenario:
