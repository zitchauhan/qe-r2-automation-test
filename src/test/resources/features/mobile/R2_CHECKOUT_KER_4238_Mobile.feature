...
Scenario: To verify that an existing ASO employee is able to see the employee discount on cart page when only few of the items are applied with employee discount
	...
	@R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-4238 @ZYP_CHECKOUT_K4238-10747 @CR-AKK	
...
@R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-4238 @ZYP_CHECKOUT_K4238-10745 @CR-AKK
