...
@R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-3779 @ZYP_CHECKOUT_K3779-10813 @CR-RKA
...
When user will click on Checkout button and navigates to Checkout page
 ...
 @R2_Mobile @R2_Regression @R2_All @P-Highest @1HR @C-Checkout @KER-3779 @ZYP_CHECKOUT_K3779-10817 @CR-RKA
...
Then user click on Add to Cart Button 
 ...
 @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-3779 @ZYP_CHECKOUT_K3779-10877 @CR-RKA
