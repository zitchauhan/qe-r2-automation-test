...
Scenario: Verify the user gets the error message when login from non-registered email id
	Given user launches the browser and navigates to "ASO_HOME" page 
	And User clicks on the burger menu
	When user clicks on sign in link from burger menu r 
...
#Scenario: Verify user referenced back to the same page from where sign is triggered
#	Given user launches the browser and navigates to "ASO_HOME" page
#	And user clicks on one of the category and navigates to LOne 
#	And user clicks on one of the subcategory and navigates to LTwo 
#	And user is able to see the product category name in section title 
