Feature: E02-100 - My Account, Address Book
     ...
     @R2_Mobile @R2_Regression @R2_All @P-High @C-My_Account @KER-4232 @ZYP_CART-K4232-9334 @CR-RK 
Scenario: Verify Authenticated user can Manage Address Book - Add new Address details - Validation Messages 
	...
	@R2_Mobile @R2_Regression @R2_All @P-High @C-My_Account @KER-4232 @ZYP_CART-K4232-9333 @CR-RK 
