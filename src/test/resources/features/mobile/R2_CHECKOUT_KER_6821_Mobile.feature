Feature: Verfiy Gift Card - Payment Validation in Checkout
  ...
  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-7957_M @CR-AKK
  ...
  @R2_Mobile @R2_Regression @R2_All @P-Highest @1HR_R2 @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-10203_M @CR-AKK
  Scenario: Verify the error message when user enters the invalid Gift card number
    Given user launches the browser and navigates to "ASO_HOME" page
    And User clicks on the burger menu 
	And User navigates to LThree 
...
#
#  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-10194_M @CR-AKK
...
#      | InvalidGiftCardNumber_Txt                            |
#
#  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-10192_M @CR-AKK
...
#    And user click on Apply button
#
#  @R2_Mobile @R2_Regression @R2_All @P-Low @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-7960_M @CR-AKK
...
#      | InvalidGiftCardNumber_Txt                            |
#
#  @R2_Mobile @R2_Regression @R2_All @P-High @C-Checkout @KER-6821 @ZYP_CHECKOUT_K6821-10202_M @CR-AKK
