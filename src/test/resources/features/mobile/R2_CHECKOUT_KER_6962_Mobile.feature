Feature: Verify Gift Card - Payment Processing
  ...
  @R2_Mobile @C-Order @CC-Checkout_Order @R2_All @P-Medium @KER-6962 @ZYP_CART_K6962-8890 @CR-SK
  ...
  @R2_Mobile @R2_All @P-Low @C-Order @CC-Checkout_Order @KER-6962 @ZYP_CART_K6962-8899 @CR-SK
  ...
  @R2_Mobile @R2_All @P-Medium @C-Order @CC-Checkout_Order @KER-6962 @ZYP_CART_K6962-8900 @CR-SK
  ...
  @R2_Mobile @C-Order @CC-Checkout_Order @R2_All @P-Medium @KER-6962 @ZYP_CART_K6962-12324 @CR-SK
