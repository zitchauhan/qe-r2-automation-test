Feature: B06-225- BOPIS Age Restriction Flag in Checkout
  ...
  @C-BOPIS @R2_Mobile @C-Order @CC-Cart_Order @R2_All @P-Low   @KER-3174 @ZYP_CART_K3174-KER-10273 @CR-RK
  Scenario: Verify guest user is able to place the BOPIS order
	...
	And user able to see the button place order
	 ...
	 @C-BOPIS @R2_Mobile @C-Order @CC-Cart_Order @R2_All @P-Low   @KER-3174 @ZYP_CART_K3174-KER-10275 @CR-RK
