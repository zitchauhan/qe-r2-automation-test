...
public class R2_CHECKOUT_K4238_SD extends CommonActionHelper {
	...
	public void user_verify_the_employee_discount_is_visible_at_item_level_when_deal_items_are_there()
			throws Throwable {
		Boolean flag = false;
		assertTrue(isDisplayed(r2CheckOutPo.employeeDiscountItemLevel_CartPage));
		flag = getfindElementByXPath("//*[@title=" + "\"" + productName + "\""
				+ "]/parent::div//*[(contains(text(),'Employee Discount applied'))]").isDisplayed();
