...
@Then("^user validates the Academy Credit Card and Credit Card modules$")
public void user_validates_the_Academy_Credit_Card_and_Credit_Card_modules() throws Throwable {
