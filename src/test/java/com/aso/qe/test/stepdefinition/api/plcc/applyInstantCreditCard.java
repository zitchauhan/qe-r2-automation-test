...
public class applyInstantCreditCard extends JSONValidationUtils {
	...
	public void endpoint_with_for_applying_instant_credit_card(String PLCCApplyInstantCardURLr2, String PLCCApplyInstantCardPostRequest) throws Throwable {
		...
		String postRequestStr = JSONValidationUtils.convertJsonFileToString(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyInstantCardPostRequest)+".json");
		logger.info(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyInstantCardPostRequest)+".json");
	}
	...
	public void endpoint_with_for_applying_invalid_instant_credit_card(String PLCCApplyMissingZipCodeInstantCardURLr2, String PLCCApplyMissingZipCodeInstantCardPostRequest) throws Throwable {
		...
		logger.debug("END Point URL:"+endpoints);
		String postRequestStr = JSONValidationUtils.convertJsonFileToString(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyMissingZipCodeInstantCardPostRequest)+".json");
		logger.info(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyMissingZipCodeInstantCardPostRequest)+".json");
	}
	...
	public void endpoint_with_Not_found_error_for_applying_invalid_instant_credit_card(String PLCCApplyInvalidInstantCardInvalidURL, String PLCCApplyInvalidInstantCardPostRequest) throws Throwable {
		...
		logger.debug("END Point URL:"+endpoints);
		String postRequestStr = JSONValidationUtils.convertJsonFileToString(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyInvalidInstantCardPostRequest)+".json");
		logger.info(JsonReaderCommonPlcc.jsonRequestFolderPathPLCC+ loadProps.getTestDataProperty(PLCCApplyInvalidInstantCardPostRequest)+".json");
	}
