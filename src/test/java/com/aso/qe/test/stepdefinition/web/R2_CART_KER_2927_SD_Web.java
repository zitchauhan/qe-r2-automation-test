...
//	GlobalElementHeader_HomePO globalElementHeader = PageFactory.initElements(driver, GlobalElementHeader_HomePO.class);
//	R2_CART_PO cartR2PageObj = PageFactory.initElements(driver, R2_CART_PO.class);
//	R2_Checkout_PO checkoutR2PageObj = PageFactory.initElements(driver, R2_Checkout_PO.class);
//	
...
//=======
//		float currentTaxDisplayed = checkoutR2PageObj.getEstimatedTaxOnCheckoutPage();
//		assertTrue(taxDisplayed != currentTaxDisplayed);
//>>>>>>> Stashed changes
	}
