...
public class R2_CheckOut_PO extends CommonActionHelper {
	...
	// @FindBy(xpath = "//div[contains(text(), 'Estimated
	// Taxes')]/following-sibling::div[1]")
	...
	// @FindBy(xpath =
	// "(//*[@data-auid='checkout_order_summary_edit_cart_link'])[2]")
	...
	@FindBy(xpath = "//*[text()='Email Address']/following::*[3]")
	public WebElement WelcomeBackEmailAddress_Input;
	@FindBy(xpath = "//*[text()='Password']/following::*[2]")
	public WebElement WelcomeBackPassword_Input;
	@FindBy(xpath = "//*[@data-auid='btnemail-signin-button']")
	public WebElement WelcomeBackSignIN_Btn;

	// Sign in Check out (End)
	// Order Summary(Start)

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Order Summary')]")
	public WebElement OrderSummary_Txt;
	@FindBy(xpath = "//*[text()='Subtotal']/..")
	public WebElement txtSubTotal;// subtotal_txt
	@FindBy(xpath = "//*[text()='Subtotal']/../*[2]")
	public WebElement SubTotalPrice_Txt;// subtotal_price

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Shipping')]")
	public WebElement Shipping_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Shipping')]/following-sibling::*[1]")
	public WebElement ShippingPrice_Txt;
	@FindBy(xpath = "//*[text()='Estimated Shipping']/..")
	public WebElement txtEsitmatedShipping;// estimatedshippint_txt
	@FindBy(xpath = "//*[text()='Estimated Shipping']/../*[2]")
	public WebElement EstimatedShippingPrice_txt;// estimatedshipping_price

	@FindBy(xpath = "//*[contains(text(),'Taxes')]")
	public WebElement Taxes_Txt;// taxprice_txt
	@FindBy(xpath = "//*[contains(text(),'Taxes')]/following-sibling::*[1]")
	public WebElement TaxesPrice_Txt;// taxprice
	@FindBy(xpath = "//*[contains(text(),'Estimated Taxes')]")
	public WebElement EstimatedTax_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Taxes')]/following-sibling::*[1]")//CR-SK 14 Sep
	public WebElement txtEstimatedTax;// estimatedPrice_Txt

	@FindBy(xpath = "//*[text()='Total Discount']")
	public WebElement txtTotalDiscount;
	@FindBy(xpath = "//*[text()='Total Discount']/following-sibling::*[1]")
	public WebElement TotalDiscountPrice_Txt;

	@FindBy(xpath = "//*[text()= 'Total']/following-sibling::div[1]")
	public WebElement txtTotal;// Total_price
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[text()='Total']")
	public WebElement Total_txt;

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Gift Card')]")
	public WebElement giftCards_txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Gift Card')]/following-sibling::*")
	public WebElement giftCardsPrice_txt;

	// *****ITems under Order Summary (Start)

	@FindBy(xpath = "//*[@data-auid='facetdrawerundefined']//*[contains(text(),'Items')]")
	public WebElement txtItems;// Item_Txt

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']/preceding-sibling::*[1]")
	public WebElement ShippingItemAvailable_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']/*[1]")
	public WebElement ImageShippingItemAvailable;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']/*[2]/*[1]")
	public WebElement NameShippingItemAvailable_Txt;

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Color')]")
	public WebElement Color_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Color')]/following-sibling::*[1]")
	public WebElement ColorInput_Txt;

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Size')]")
	public WebElement Size_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Size')]/following-sibling::*[1]")
	public WebElement SizeInput_Txt;

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Quantity')]")
	public WebElement Quantity_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'Quantity')]/following-sibling::*[1]")
	public WebElement QuantityInput_Txt;

	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_shipping_items']//*[contains(text(),'$')]")
	public WebElement PriceShippingItemAvailable_Txt;
	@FindBy(xpath = "(//*[@data-auid='checkout_order_summary_edit_cart_link'])[2]/*")
	public WebElement btnEditCart;// EditMyCart_Link
	...
	@FindBy(xpath = "//*[@data-auid='checkout_payment']/preceding::*[1]")
	public WebElement PaymentHeader_Txt;
	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'PAYMENT METHOD')]")
	public WebElement PaymentMethodHeader_Txt;
	@FindBy(xpath = "//*[text()='Credit Card']/preceding::*[2]")
	public WebElement CreditCard_radioBtn;
	@FindBy(xpath = "//*[text()='PayPal']/preceding::*[2]")
	public WebElement PayPal_radioBtn;
	@FindBy(xpath = "//*[text()='Credit Card Number']/following::*[1]")
	public WebElement CreditCardNumber_Input;
	@FindBy(xpath = "//*[text()='Expiration Date']/following::*[1]")
	public WebElement ExpirationDate_Input;
	@FindBy(xpath = "//*[text()='CVV']/following::*[3]")
	public WebElement Cvv_Input;
	@FindBy(xpath = "//*[@data-auid='tooltipcheckout_payment_creditCard_cvv_tooltip']")
	public WebElement CvvToolTip;
	@FindBy(xpath = "//*[text()='Unrecognized card number']")
	public WebElement UnrecognizedCardNumber_Txt;
	@FindBy(xpath = "//*[text()='Past expiration date']")
	public WebElement PastExpirationDate_Txt;
	@FindBy(xpath = "//*[text()='Please enter a valid security code']")
	public WebElement PleaseEnteRaValidSecurityCode_Txt;
	@FindBy(xpath = "//*[contains(text(),'Visa ending in')]")
	public WebElement chooseCreditcard_Dd;
	@FindBy(xpath = "//*[@data-auid='undefined_listOption_1']")
	public WebElement AddNewCreditCard_Txt;
	// *****************Payment Method (END)

	// ****************Gift Card(Start)

	@FindBy(xpath = "//*[@data-auid='checkout_payment_add_gift_card_icon']")
	public WebElement plusIconGiftCard; // Plus_GiftCard
	@FindBy(xpath = "//*[@data-auid='checkout_payment_hide_gift_card_icon']")
	public WebElement minusIconGiftCard;// Hide_GiftCard
	@FindBy(xpath = "//*[text()='Gift Card Number']")
	public WebElement txtGiftcardNumber;// GiftCardNumber_Txt
	@FindBy(xpath = "//*[@name='cardId']")
	public WebElement inputGiftcardNumber;// GiftCardNumber_Input
	@FindBy(xpath = "(//*[@data-auid='tooltipcheckout_payment_gift_card_tooltip'])[1]")
	public WebElement toolTip_giftCard;// GiftCardNumber_Tooltip
	@FindBy(xpath = "//*[text()='Invalid GiftCard Number']")
	public WebElement txtInvalidGiftcard;// InvalidGiftCardNumber_Txt
	@FindBy(xpath = "//*[text()='Pin']")
	public WebElement txtPin;// Pin_Txt
	@FindBy(xpath = "//*[@name='cardPin']")
	public WebElement inputPinNumber;// Pin_Input
	@FindBy(xpath = "(//*[@data-auid='tooltipcheckout_payment_gift_card_tooltip'])[2]")
	public WebElement toolTip_pin;
	@FindBy(xpath = "//*[text()='Invalid GiftCard Pin']")
	public WebElement txtInvalidPin;// InvalidGiftCardPin_Txt
	@FindBy(xpath = "//*[@data-auid='btncheckout_payment_apply_gift_card_btn']")
	public WebElement btnCheckoutApply; // Apply_Btn

	// ****************Gift Card(End)

	// *************** Billing Information(Start)
	@FindBy(xpath = "//*[text()='BILLING INFORMATION']")
	public WebElement BillingInformation_Txt;
	@FindBy(xpath = "//*[text()='Same As Shipping Address']/following::*[3]")
	public WebElement SameAsShippingAddress_Txt;
	@FindBy(xpath = "//*[text()='Same As Shipping Address']/preceding::*[1]")
	public WebElement SameAsShippingAddress_checkBox;

	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'First Name')]/following::*[2]")
	public WebElement FirstName_Input;
	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'Last Name')]/following::*[2]")
	public WebElement LastName_Input;
	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'Phone Number')]/following::*[2]")
	public WebElement PhoneNumber_Input;

	@FindBy(xpath = " //*[contains(text(),'Send SMS text updates about my order')]/preceding::*[1]")
	public WebElement SendSMSTextUpdatesAboutMyOrder_checkbox;
	@FindBy(xpath = "//*[@name='billingAddress1']")
	public WebElement Adderss_Input;
	@FindBy(xpath = "//*[contains(text(),'Add Company Name, Apt. Number, etc. (Optional)')]")
	public WebElement AddCompanyNameAptNumberEtcOptional_Txt;
	@FindBy(xpath = "//*[contains(text(),'Add Company Name, Apt. Number, etc. (Optional)')]/following::*[2]")
	public WebElement AddCompanyNameAptNumberEtcOptional_Input;

	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'ZIP Code')]/following::*[2]")
	public WebElement ZipCode_Input;
	@FindBy(xpath = "//*[@data-auid='checkout_payment']//*[contains(text(),'City')]/following::*[2]")
	public WebElement city_Input;
	@FindBy(xpath = "//*[text()='State']/following::*[1]")
	public WebElement State_DD;

	@FindBy(xpath = "//*[@data-auid='checkout_payment']\r\n"
			+ "//*[contains(text(),'Email Address for Order Confirmation')]/following::*[2]/input")
	public WebElement EmailAddressforOrderConfirmation_Input;

	@FindBy(xpath = "//*[contains(text(),'Sign up to get Hot Deals')]/preceding::*[1]")
	public WebElement SignuptogetHotDeals_checkBox;

	@FindBy(xpath = "//*[@data-auid='btnundefined']")
	public WebElement ReviewOrder_Btn;
	@FindBy(xpath = "//*[@data-auid='checkout_edit_payment']")
	public WebElement EditPayment_Link;
	@FindBy(xpath = "//*[text()='Change Billing Information']")
	public WebElement ChangeBillingInformation_Txt;

	@FindBy(xpath = "//input[@id='paypal']/..")
	public WebElement rdPaypal;// PayPal_radioBtm;
	@FindBy(xpath = "//*[text()=' Checkout']/..")
	public WebElement PayPalCheckOut_Btn;
	...
	public WebElement EditMyCart_Link_M;
	...
	@FindBy(xpath = "//*[text()='SHIPPING ADDRESS']/following::*[1]")
	public WebElement shippingAddressFirst_LastName;
	@FindBy(xpath = "//*[text()='Same As Shipping Address']/ancestor::div[1]/following::*[3]")
	public WebElement billingAddressFirst_LastName;

	@FindBy(xpath = "//*[text()='SHIPPING ADDRESS']/following::*[3]")
	public WebElement shippingAddressphoneNumber;
	@FindBy(xpath = "//*[text()='Same As Shipping Address']/ancestor::div[1]/following::*[5]")
	public WebElement billingZip_Phone;

	@FindBy(xpath = "//*[text()='SHIPPING ADDRESS']/following::*[2]")
	public WebElement shippingCityCountryName;
	@FindBy(xpath = "//*[text()='Same As Shipping Address']/ancestor::div[1]/following::*[4]")
	public WebElement billingCityCountryName;
	// KER-CR-4058 RKA
	@FindBy(xpath = "//*[text()='ADDRESS VERIFICATION']")
	public WebElement AddressVerification_MSG;// For restricted item after clicking on go to shipMethod

	// Sep7 CR-RK KER-3151

	@FindBy(xpath = "//*[@data-auid='checkout_edit_shipping_address']")
	public WebElement Checkout_ShippingAddress_Edit;
	@FindBy(xpath = "//*[@data-auid='checkout_edit_shipping_address']/../../div[2]")
	public WebElement Checkout_ShippingAddress_Default;
	@FindBy(xpath = "//*[@name='Dropdown']/button")
	public WebElement Checkout_ShippingAddressAfterEdit_ShippingAddress_Dd;
	@FindBy(xpath = "//*[text()='Add a New Shipping Address']")
	public WebElement Checkout_ShippingAddressAfterEdit_AddaNewShippingAddress;
	// Sep7 CR-RK KER-3151

	// Start Sep10 KER-6576 CR-RK
	@FindBy(xpath = "//*[@data-auid='checkout_footer_legal_link_Privacy Policy']")
	public WebElement checkoutFooterLegalLinkPrivacyPolicy; // 10-September
	@FindBy(xpath = "//*[@data-auid='checkout_footer_chat_now_link']")
	public WebElement checkoutFooterChatNowLink; // 10-September
	@FindBy(xpath = "//*[@data-auid='checkout_footer_contact_number_link_m']")
	public WebElement checkoutFooterContactNumberLink_mobile; // 10-September
	@FindBy(xpath = "//*[@data-auid='checkout_footer_legal_link_Terms & Conditions']")
	public WebElement checkoutFooterLegalLinkTermsConditions; // 10-September
	@FindBy(xpath = "//*[@data-auid='checkout_footer_legal_link_California Proposition 65 California Transparency in Supply Chains Act (SB 657)']")
	public WebElement checkoutFooterLegalLinkCaliforniaProposition65; // 10-September
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_Visa_icon']")
	public WebElement iconVisa;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_Master Card_icon']")
	public WebElement iconMasterCard;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_Paypal_icon']")
	public WebElement iconPaypal;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_GooglePay_icon']")
	public WebElement iconGooglePay;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_ApplePay_icon']")
	public WebElement iconApplePay;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_Amex Card_icon']")
	public WebElement iconAmericanExpress;
	@FindBy(xpath = "//*[@data-auid='checkout_footer_accepted_card_Discover_icon']")
	public WebElement iconDiscover;
	@FindBy(xpath = "//*[text()='Privacy']")
	public WebElement checkoutFooterLegalLinkPrivacyPolicy_txt; // 10-September
	@FindBy(xpath = "//*[text()='Terms and ']")
	public WebElement checkoutFooterLegalLinkTermsConditions_txt; // 10-September
	@FindBy(xpath = "//*[text()='California Transparency in Supply Chains Act (SB 657)']")
	public WebElement checkoutFooterLegalLinkCaliforniaProposition65_txt; // 10-September
	...
	public void verifyShippingAndBillingAddressAreSame() throws InterruptedException {
		...
		assertEquals(getText(shippingCityCountryName).subSequence(0, 15),
				getText(billingCityCountryName).substring(0, 15));
	}

	/***************************** END METHODS *********************************/
	/** SID **************************************/

	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVE']/p[1]")
	public WebElement textBasicDelivery; // SID 5-September
	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVE']/p[2]")
	public WebElement textBasicDeliverMessage; // SID 5-September
	@FindBy(xpath = "   (//*[@data-auid='btnc_btnCheckout'])[2]")
	public WebElement btnCheckOut_M; // SID 5-September
	@FindBy(xpath = "//*[contains(text(),'Basic Delivery')]/ancestor::button")
	public WebElement clickShippingWGDropDown; // SID 6-September
	@FindBy(xpath = "//*[contains(text(),'Basic Delivery')]/ancestor::button/parent::div//ul/li")
	public List<WebElement> WGServicesList; // SID 6-September
	@FindBy(xpath = "//*[contains(text(),'Basic Delivery')]/ancestor::button/parent::div//ul/li/*[contains(text(),'Scheduled')]")
	public WebElement WGScheduleService; // SID 5-September
	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVETHRESHOLD']/p[1]")
	public WebElement textScheduleDelivery; // SID 6-September
	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVETHRESHOLD']/p[2]")
	public WebElement textSchedukeDeliverMessage; // SID 6-September
	@FindBy(xpath = "//*[contains(text(),'Basic Delivery')]/ancestor::button/parent::div//ul/li/*[contains(text(),'Room')]")
	public WebElement WGRoomOfChoiceService; // SID 5-September
	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVEROC']/p[1]")
	public WebElement textRoomOfChoiceDelivery; // SID 6-September
	@FindBy(xpath = "//*[@data-auid='checkout_shipping_method_shipment_itemWHITEGLOVEROC']/p[2]")
	public WebElement textRoomOfChoiceDeliverMessage; // SID 6-September
	@FindBy(xpath = "(//*[@data-component='cart']//*[text()='Employee Discount applied'])[1]")
	public WebElement employeeDiscountItemLevel_CartPage; // SID 13-September
	@FindBy(xpath = "//*[@data-auid='checkout_order_summary_section']//*[contains(text(),'Employee Discount')]")
	public WebElement employeeDiscountOrderSummerPage; // SID 13-September
	@FindBy(xpath = "(//*[contains(@data-auid,'level3Category')])[1]//img")
	public WebElement dealTabProduct; // SID 5-September
	...
	public void checkWGservicesAvailable() {
		...
		for (int i = 1; i <= size; i++) {
			...
			flag = isDisplayed(driver
					.findElement(By.xpath("//*[contains(text(),'Basic Delivery')]/ancestor::button/parent::div//ul/li["
							+ i + "]/*[contains(text(),'" + WGServices.get(i - 1) + "')]")));
	...
	@FindBy(xpath = "//*[@data-auid='checkout_payment']")
	public WebElement secPayment;
	@FindBy(xpath = "//*[text()='PAYMENT METHOD']")
	public WebElement secPaymentHeading;
	@FindBy(xpath = "//*[@id='creditCard']")
	public WebElement rdbtnCreditCard;
	@FindBy(xpath = "//*[text()='Credit Card']")
	public WebElement txtCreditCard;
	@FindBy(xpath = "//*[@id='PayPal']")
	public WebElement rdbtnPayPal;
	@FindBy(xpath = "//*[text()='PayPal']")
	public WebElement txtPaypal;
	@FindBy(xpath = "//*[@id='gpay'] | //*[@id='GooglePay']")
	public WebElement rdbtnGooglePay;
	@FindBy(xpath = "//*[text()='Google Pay']")
	public WebElement txtGooglePay;
	@FindBy(xpath = "//*[text()='Credit Card Number']")
	public WebElement txtCreditCardHeading;
	@FindBy(xpath = "//*[@id='creditcardField']")
	public WebElement txtCreditCardInput;
	@FindBy(xpath = "//*[@id='creditcardField']//following-sibling::span/img[contains(@src,'visa')]")
	public WebElement imgVisaCreditCardInput;
	@FindBy(xpath = "//*[text()='Expiration Date']")
	public WebElement txtExpirationDate;
	@FindBy(xpath = "//*[@id='expirationDate']")
	public WebElement txtExpirationDateInput;
	@FindBy(xpath = "//*[@placeholder='MM/YY']")
	public WebElement txtExpirationPlaceholders;
	@FindBy(xpath = "//*[@id='expirationDate']//parent::label//following-sibling::div/span[contains(text(),'Past expiration date')]")
	public WebElement txtErrorMsgForPastDates;
	@FindBy(xpath = "//*[@id='cvv']")
	public WebElement txtCVVInput;
	@FindBy(xpath = "//*[@data-auid='tooltipcheckout_payment_creditCard_cvv_tooltip']")
	public WebElement btnCVVToolTip;
	@FindBy(xpath = "//*[text()='The 3 digit code found on far right of signature box']")
	public WebElement txtCVVToolTipMsg;
	...
	@FindBy(xpath = "//*[text()='Unrecognized expiration date']")
	public WebElement unrecognizedExpirationDate_Txt;

	/** AG KER-3130 Ends **************************************/
	// To be updated by Anuj
	/** AG KER-3130 Starts **************************************/

	@FindBy(xpath = "//*[@id='billingFirstName']//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingFirstNameErrorMsg;
	@FindBy(xpath = "//*[@id='billingLastName']//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingLastNameErrorMsg;
	@FindBy(xpath = "//*[@id='billingPhoneNumber']//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingPhoneNumberErrorMsg;
	@FindBy(xpath = "//*[@id='billingZipCode']//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingZipCodeErrorMsg;
	@FindBy(xpath = "//*[@id='billingCity']//following-sibling::*[contains(text(),'Required')]")
	public WebElement txtBillingCityErrorMsg;
	@FindBy(xpath = "//*[@id='email']//parent::div//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingEmailAddressForOrderConfirmationErrorMsg;
	@FindBy(xpath = "//*[@id='billingAddress1']//following-sibling::*[contains(text(),'Please')]")
	public WebElement txtBillingAddressErrorMsg;
	@FindBy(xpath = "//*[@id='billingState']//following-sibling::*[contains(text(),'Required')]")
	public WebElement txtBillingStateErrorMsg;
	@FindBy(xpath = "//*[@id='billingAddress1']")
	public WebElement txtEmailAddressforOrderConfirmationInput;
	@FindBy(xpath = "//*[@data-auid='btnPlace_Order']")
	public WebElement btnPlaceOrderPaymentPage;
	@FindBy(xpath = "//*[@id='billingZipCode']//following-sibling::*[contains(text(),'Invalid')]")
	public WebElement txtBillingZipCodeInvalidErrorMsg;
	@FindBy(xpath = "//*[@id='email']//parent::div//following-sibling::*[contains(text(),'Enter a valid email')]")
	public WebElement txtBillingEmailAddressForOrderConfirmationInvalidErrorMsg;
