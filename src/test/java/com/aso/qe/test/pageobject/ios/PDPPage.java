...
public class PDPPage {
	...
	public boolean isQuantityStepperDisplayed() {
		boolean isQtyIncrementStepperDisplayed = GlobalMobileHelper
				.isElementDisplayed(Locators.PDPPage.qtyIncrementStepper);
		boolean isQtyDecrementStepperDisplayed = GlobalMobileHelper
				.isElementDisplayed(Locators.PDPPage.qtyDecrementStepper);
		boolean isQtEditBoxDisplayed = GlobalMobileHelper.isElementDisplayed(Locators.PDPPage.qtyEditBox);

		return isQtyIncrementStepperDisplayed && isQtyDecrementStepperDisplayed && isQtEditBoxDisplayed;
	}
	...
	public boolean isMessageDisplayed(String args) throws Exception {
		...
		if (args.equalsIgnoreCase("important_Product_and_Safety_Information")) {
			...
			if (!(driver.findElement(Locators.PDPPage.ProductSafetyInformation).getText()
					.equalsIgnoreCase(textguidelines))) {
			...
			if (!(driver.findElement(Locators.PDPPage.ProductSafetyInformationPara1).getText()
					.equalsIgnoreCase(InformationPoint1))) {
			...
			if (!(driver.findElement(Locators.PDPPage.ProductSafetyInformationPara2).getText()
					.equalsIgnoreCase(InformationPoint2))) {
			...
			if (!(driver.findElement(Locators.PDPPage.ProductSafetyInformationPara3).getText()
					.equalsIgnoreCase(InformationPoint3))) {
			...
			if (!(driver.findElement(Locators.PDPPage.ProductSafetyInformationPara4).getText()
					.equalsIgnoreCase(InformationPoint4))) {
	...
	public void changeVariant(String variantType, String variantSize, String variantColor, String variantwidth) {
		 ...
		 * e.printStackTrace(); } MobileElement varientColorValue =
		 * driver.findElement(Locators.PDPPage.colorValue);
...
// To check Store Delivery and Store Pick for SOF Item 
	...
	public void isRatingsAndReviewDisplayed() {
		/*
		 * List<MobileElement> ratings =
		 * driver.findElements(Locators.ReviewPage.ratingsAndReview); for(int i = 1;
		 * i<=ratings.size(); i++) {
		 * 
		 * }
		 */
	...
	public void outOfStockitem() {
		...
		String itemstatus = driver.findElement(Locators.PDPPage.outOfStockMsg).getText();
