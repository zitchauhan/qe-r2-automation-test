...
public class R1_PDP_PO extends CommonActionHelper
{
	...
	@FindBy(xpath="//*[@data-auid='btnPickUpATC'] |(//button[@class='d-flex flex-row css-12r2ery'])[3] | (//*[text()='free store pickup'])/parent::*[1]/parent::*[1]/parent::*[1]/parent::*/parent::*[1] | //*[contains(text(),'free store pickup')]") public WebElement pickupBtn_m;
