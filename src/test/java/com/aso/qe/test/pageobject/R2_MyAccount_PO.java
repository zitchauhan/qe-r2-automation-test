...
public class R2_MyAccount_PO extends CommonActionHelper {
	...
	@FindBy(xpath = "(//div[.='Create Password']/following-sibling::div/input)[1]") 																		// "//input[@type='password']")
	...
	public WebElement txtUnregisteredEmailAddressError; 
