...
public class R2_Sanity_PO extends CommonActionHelper {
	...
	// private static final Logger logger = Logger.getLogger(R2_Sanity_PO.class);
	...
	// start danush
	@FindBy(xpath="//button[@data-auid='hamburgerMenuToggleBtn_m']")  public WebElement AS_btnXBurgerMenu;
	@FindBy(xpath="//*[@data-auid='level1Category-SHOP']") public WebElement AS_btnShopCategory;//12 Aug danush
	@FindBy(xpath="//*[@data-auid='level2Category-CLOTHING_m'] | //*[@data-auid='level2Category-CLOTHING'] ")public WebElement AS_btnClothingCategory;
	@FindBy(xpath="//*[@data-auid='level3Category-Mens']")public WebElement AS_btnMens_Clothing_Shop;
	@FindBy(xpath="//*[@data-auid='level3Category-Mens']|//*[@data-auid='level3Category-Mens_m']")public WebElement AS_btnMen_Clothing_Shop;
	@FindBy(xpath="//*[@data-auid='search-input']") public WebElement AS_txtSearchBox;
	@FindBy(xpath="//button[@data-auid='submitSearchButton'] | //*[@data-auid='search-clear-button']") public WebElement AS_btnGO;	
	@FindBy(xpath="//*[@data-auid='level4Category-Shirts_m'] | //*[@data-auid='go-to-Mens_m'] | //*[@data-auid='level4Category-Shirts']")public WebElement AS_btnMensShirt_Men_Clothing_Shop;
	...
	@FindBy(xpath="//div[@class='col-12 col-md-5 px-0 pl-md-1']") //*[text()='ORDER SUMMARY']/../../div[2]
	...
	public void verifyAppliedPromoOnCartPage(String promo	) throws InterruptedException{
		...
		Thread.sleep(2000);
		//assertTrue(isDisplayed(inputPromoCode));	
	}
	// End danush
