Feature: B06-225- BOPIS Order Confirmation Impact
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-Highest @1HR_R2 @KER-2868 @ZYP_CHECKOUT_K2868-10722 @CR-AKK
  ...
  #		|created an account|
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-Highest @1HR_R2 @KER-2868 @ZYP_CHECKOUT_K2868-10709 @CR-AKK
  Scenario: Verify that UnAuthenticated user is able to create an account on Order Confirmation page
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User searches a product "SKUForBopisProduct" and navigates to PDP
    And user click on Add to Cart Button
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-High_B_Order @KER-2868 @ZYP_CHECKOUT_K2868-10716 @CR-AKK @ZYP_CHECKOUT_K2868-10716 @CR-AKK
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-High_B_Order @KER-2868 @ZYP_CHECKOUT_K2868-10739 @CR-AKK
  Scenario: Verify that UnAuthenticated user is able to view In-Store Pickup Information on Order confirmation page
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User searches a product "SKUForBopisProduct" and navigates to PDP
    Given user launches the browser and navigates to "ASO_HOME" page
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-High_B_Order @KER-2868 @ZYP_CHECKOUT_K2868-10740 @CR-AKK
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-High_B_Order @KER-2868 @ZYP_CHECKOUT_K2868-10738 @CR-AKK
  Scenario: Verify that UnAuthenticated user is able to view Payment Details on Order confirmation page
    Given user launches the browser and navigates to "ASO_HOME" page
    Given user launches the browser and navigates to "ASO_HOME" page
    Then User searches a product "SKUForBopisProduct" and navigates to PDP
  ...
  @C-BOPIS @R2_Mobile @CC-Checkout_Order @R2_All @P-Low @KER-2868 @ZYP_CHECKOUT_K2868-10713 @CR-AKK
