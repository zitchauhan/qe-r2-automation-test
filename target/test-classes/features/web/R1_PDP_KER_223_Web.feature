...
Scenario: verify user is able to view all available colors and select it for a product on PLP
	...
	@Regression @Web @All @C-PDP @KER-223 @ZYP_PDP_K223-2022  @Rerun @CR-SG
...
@Regression @Web @All @C-PDP @KER-223 @ZYP_PDP_K223-10335  @Rerun @CR-SG @1HR
...
@Regression @Web @All @C-PDP @KER-223 @ZYP_PDP_K223-10336  @Rerun @CR-SG
